[title]: <> (Blogger Blogging And Testing CSS)
[date]: <> (2026/06/29)
[category]: <> (general)
...
<p style="text-align: right"><span>Right Text</span></p>
...
const vouchers = await Promise.all(
    invitees.map((invitee) =>
      mintVoucher({
        ...
        salt,
        invitee,
        actorAddress: ctx.account.agent.getAgentAddress(),
      })
    )
  );
```

<mark style="background-color: rgb(234, 153, 153)">Highlighted Text</mark>

1. Waiting For GTA 6
2. Its Been 14 Years
3. I am old now :(

<u>Underlined The Text</u>

<s>Striked Through Text</s>

<aside class="callout">
All Hail Gaben and Chris Metzen
</aside>